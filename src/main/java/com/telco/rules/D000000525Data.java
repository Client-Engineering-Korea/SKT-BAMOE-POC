...
public class D000000525Data implements RuleUnitData {
    ...
    public DataStore<TransactionContext> getTransactions() { return transactions; }
    public DataStore<ValidationError> getErrors() { return errors; }
}
